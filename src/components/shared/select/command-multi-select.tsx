...
const multiSelectVariants = cva(
  "rounded-none m-[2px]  transition-all duration-300 ease-in-out",
  {
    variants: {
      variant: {
        default:
          "outline-accent outline-1 text-foreground bg-card hover:bg-card/80",
        secondary:
  ...
  (
    {
      ...
      placeholderInput = "Type to search...",
      clearSelection,
      animation = 0,
      animationConfig,
      maxCount = 3,
        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 outline-1 rounded-sm border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
            ...
            >
              {selectedValues.length > 0 ? (
                <div className="flex justify-between items-center w-full">
                  <div
                    // className="outline-1 flex items-center gap-2"
                    className={cn(
                  ...
                  >
                      ...
                      .map((value) => {
                        ...
                        return (
                          <Badge
                            key={value}
                            className={cn(
                              "h-full bg-transparent outline-1 outline-accent rounded-none",
                          ...
                          >
                            ...
                            <div
                              ...
                              className=" cursor-pointer rounded-sm  focus:outline-none focus:ring-1 focus:ring-white/50"
                            >
                              <X
                                className={cn(
                                  "h-2 w-2 opacity-60 hover:opacity-100",
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        className={cn(
                          "h-full bg-transparent text-foreground border-foreground/1 hover:bg-transparent",
          ...
          <PopoverContent
            ...
            // className={cn(
            //   ' p-0 w-full min-w-[var(--radix-popper-anchor-width)]',
                ...
                {!hideSelectAll && !searchValue && (
                  <CommandGroup>
                    ...
                    >
                      <div className="flex">
                        {iconListAll && (
                          <ListCheck className="mr-2 h-4 w-4 text-muted-foreground" />
                        )}
                        <span>
                          Seleccionar todos (
                          {
                      ...
                      {selectedValues.length ===
                        getAllOptions().filter((opt) => !opt.disabled)
                          .length && <CheckIcon className="h-4 w-4" />}
                    </CommandItem>
                  </CommandGroup>
                )}
                <CommandSeparator />
                      ...
                      return (
                        <CommandItem
                          ...
                          className={cn(
                            ...
                            isSelected && "rounded-none opacity-90 underline",
                          )}
                        >
                          <div className="flex">
                            {option.icon && (
