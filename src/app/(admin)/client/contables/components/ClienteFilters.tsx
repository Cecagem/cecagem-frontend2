...
import { SearchFilters, ClienteEstado } from "../types";
...
export function ClienteFilters({ filters, onApplyFilters, onClearFilters }: ClienteFiltersProps) {
  ...
  const handleEstadoChange = useCallback((value: string) => {
    setLocalFilters(prev => ({
      ...prev,
      estado: value === "all" ? undefined : (value as ClienteEstado),
    }));
  }, []);
    ...
    <Card className="border shadow-sm">
      ...
      <CardContent>
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-1 lg:flex lg:gap-3">
            {/* Filtro por estado */}
