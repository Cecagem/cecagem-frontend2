...
import {
  ...
  ClienteContable,
  ClienteContableStatsCards,
  ClienteContableFilters,
  ClienteContableTable,
  ClienteContableForm,
  DeleteConfirmation,
} from "@/features/client-accounting";
  ...
  return (
    <div className="flex min-w-0 flex-1 flex-col">
      ...
      <main className="flex flex-1 flex-col gap-6 p-4 md:p-6">
        ...
        {/* Estadísticas */}
        <ClienteContableStatsCards stats={stats} isLoading={isLoading} />
