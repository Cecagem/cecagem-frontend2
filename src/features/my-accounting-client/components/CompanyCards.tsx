...
import { Building2, User, ChevronRight, ChevronLeft, ChevronsLeft, ChevronsRight } from "lucide-react";
...
interface CompanyCardsProps {
  ...
  filters?: Partial<ICompanyFilters>;
}
...
export const CompanyCards = ({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Paginación mejorada */}
      {paginationMeta && companies.length > 0 && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-4">
            ...
            <div className="flex items-center justify-center gap-1 order-1 sm:order-2">
              ...
              <div className="flex items-center px-3">
                <span className="text-sm font-medium whitespace-nowrap">
                  {paginationMeta.page} / {paginationMeta.totalPages || Math.ceil(paginationMeta.total / (filters?.limit || 6))}
                </span>
              </div>
            ...
            <div className="flex justify-center sm:justify-end order-3">
              <div className="text-sm text-muted-foreground text-center sm:text-right">
                Mostrando {((paginationMeta.page - 1) * (filters?.limit || 6)) + 1} a{' '}
                {Math.min(paginationMeta.page * (filters?.limit || 6), paginationMeta.total)} de {paginationMeta.total}
              </div>
            </div>
          </div>
        </div>
