...
export const CompanyExpandedView: React.FC<CompanyExpandedViewProps> = ({
  company,
}) => {
  ...
  const activeContracts = company.contract.filter(
    (contract) => contract.isActive
  );
  const totalMonthlyRevenue = activeContracts.reduce(
    (total, contract) => total + contract.monthlyPayment,
    0
  );

  // Obtener todas las cuotas de todos los contratos
  const allInstallments = activeContracts.flatMap(
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          <Badge
                            variant={
                              company.isActive ? "default" : "destructive"
                            }
                          >
