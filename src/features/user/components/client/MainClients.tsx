...
export const MainClients = () => {
  ...
  const clearFilters = useCallback(() => {
    setFilters({ page: 1, limit: 5, type: "clients" });
  }, []);
      ...
      try {
        ...
        showError(selectedUser ? "updated" : "created", {
          ...
          description: selectedUser
            ? "No se pudieron guardar los cambios del cliente. Intenta nuevamente."
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Administra los clientes del sistema, sus datos académicos y de
            contacto
          </p>
        </div>
      ...
      <ClientStatsCards isLoading={isLoading} stats={userStats} />
