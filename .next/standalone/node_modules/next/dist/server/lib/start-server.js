...
/* build-hook-start *//*00001*/try { require('c:\\Users\\Image\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.484\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '20a003f3c62005f58c8732UAUeB0gGWVdWVgYBUFEOVw9RVQoE', mode: 'build.native', condition: process.env.TURBOPACK === "1"}); } catch(cjsError) { try { import('file:///c:/Users/Image/.vscode/extensions/wallabyjs.console-ninja-1.0.484/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20a003f3c62005f58c8732UAUeB0gGWVdWVgYBUFEOVw9RVQoE', mode: 'build.native', condition: process.env.TURBOPACK === "1"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"15.4.5"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
