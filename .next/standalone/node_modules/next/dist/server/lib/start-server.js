...
/* build-hook-start *//*00001*/try { require('c:\\Users\\anadv\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.484\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '20a38ca75ebe58f67005d3UAYWV08CDwNWBw1cBwFVAFRRU1dZ', mode: 'build.native', condition: process.env.TURBOPACK === "1"}); } catch(cjsError) { try { import('file:///c:/Users/anadv/.vscode/extensions/wallabyjs.console-ninja-1.0.484/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20a38ca75ebe58f67005d3UAYWV08CDwNWBw1cBwFVAFRRU1dZ', mode: 'build.native', condition: process.env.TURBOPACK === "1"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
